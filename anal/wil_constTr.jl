...
elseif ens.id == "D200"
    ...
    fpi = get_f_wil(pp_sym[1], ap_sym[1], mpi[1], ens, "pion_wil", pl=true, wpm=wpm, tm=[[1], [60,65]], tM=[[80], [70,80]])
    fk = get_f_wil(pp_sym[2], ap_sym[2], mk[1], ens, "kaon_wil", pl=true, wpm=wpm, tm=[[1], [30,40,60]], tM=[[80], [80,92]])
else
