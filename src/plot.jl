function matching_sym_plot()
    ...
    errorbar(x[1:3,2], value.(m12_sh[1:3]), err.(m12_sh[1:3]), fmt="x", color="purple", label=L"$a\mu_l^{\rm(v)}=???$")
    errorbar(x[4:6,2], value.(m12_sh[4:6]), err.(m12_sh[4:6]), fmt="x", color="green", label=L"$a\mu_l^{\rm(v)}=???$")
    errorbar(x[7:9,2], value.(m12_sh[7:9]), err.(m12_sh[7:9]), fmt="x", color="blue", label=L"$a\mu_l^{\rm(v)}=???$")
    ...
    errorbar(x[1:3,2], value.(phi2_sh[1:3]), err.(phi2_sh[1:3]), fmt="x", color="purple", label=L"$a\mu_l^{\rm(v)}=???$")
    errorbar(x[4:6,2], value.(phi2_sh[4:6]), err.(phi2_sh[4:6]), fmt="x", color="green", label=L"$a\mu_l^{\rm(v)}=???$")
    errorbar(x[7:9,2], value.(phi2_sh[7:9]), err.(phi2_sh[7:9]), fmt="x", color="blue", label=L"$a\mu_l^{\rm(v)}=???$")
    mul_target = up[2]; uwerr(mul_target)
...
function interp_fpik_sym_plot()
    ...
    e = err.(vect)
    fill_between(xp[:,2], v-e, v+e, color="orange", alpha=0.5)
    errorbar(x[1:3,2], value.(fpik_sh[1:3]), err.(fpik_sh[1:3]), fmt="x", color="purple", label=L"$a\mu_l^{\rm(v)}=???$")
    errorbar(x[4:6,2], value.(fpik_sh[4:6]), err.(fpik_sh[4:6]), fmt="x", color="green", label=L"$a\mu_l^{\rm(v)}=???$")
    errorbar(x[7:9,2], value.(fpik_sh[7:9]), err.(fpik_sh[7:9]), fmt="x", color="blue", label=L"$a\mu_l^{\rm(v)}=???$")
    mul_target = up[2]; uwerr(mul_target)
...
function matching_constTr_plot()
    ...
    fill_between(1 ./ xp[:,1], v-e, v+e, color="orange", alpha=0.5)
    fill_between(1 ./ xp[:,1], 0, 0, color="gray", alpha=0.5)
    errorbar(1 ./ x_l[1:3:9,1], value.(m12_sh[1:3:9]), err.(m12_sh[1:3:9]), fmt="x", color="purple", label=L"$a\mu_l^{\rm(v)}=???$")
    ...
    fill_between(xp[:,2], v-e, v+e, color="orange", alpha=0.5)
    fill_between(xp[:,2], 0, 0, color="gray", alpha=0.5)
    errorbar(x_l[1:3,2], value.(m12_sh[1:3]), err.(m12_sh[1:3]), fmt="x", color="purple", label=L"$a\mu_l^{\rm(v)}=???$")
    errorbar(x_l[4:6,2], value.(m12_sh[4:6]), err.(m12_sh[4:6]), fmt="x", color="green", label=L"$a\mu_l^{\rm(v)}=???$")
    errorbar(x_l[7:9,2], value.(m12_sh[7:9]), err.(m12_sh[7:9]), fmt="x", color="blue", label=L"$a\mu_l^{\rm(v)}=???$")
    mul_target = up[2]; uwerr(mul_target)
    errorbar(value(mul_target), 0, 0, err(mul_target), fmt="x", color="black")
    ax[:set_ylim]([value(m12_sh[end])*1.5, value(m12_sh[1])*1.5])
    setp(ax.get_xticklabels(),visible=false)
    ...
    fill_between(1 ./ xp[:,1], v-e, v+e, color="orange", alpha=0.5)
    fill_between(1 ./ xp[:,1], v2-e2, v2+e2, color="gray", alpha=0.5)
    errorbar(1 ./ x_s[1:3:9,1], value.(phi4_sh[1:3:9]), err.(phi4_sh[1:3:9]), fmt="x", color="purple", label=L"$a\mu_l^{\rm(v)}=???$")
    ...
    fill_between(xp[:,2], v-e, v+e, color="orange", alpha=0.5)
    fill_between(xp[:,2], v2-e2, v2+e2, color="gray", alpha=0.5)
    errorbar(x_s[1:3,2], value.(phi4_sh[1:3]), err.(phi4_sh[1:3]), fmt="x", color="purple", label=L"$a\mu_l^{\rm(v)}=???$")
    errorbar(x_s[4:6,2], value.(phi4_sh[4:6]), err.(phi4_sh[4:6]), fmt="x", color="green", label=L"$a\mu_l^{\rm(v)}=???$")
    errorbar(x_s[7:9,2], value.(phi4_sh[7:9]), err.(phi4_sh[7:9]), fmt="x", color="blue", label=L"$a\mu_l^{\rm(v)}=???$")
    mul_target = up[2]; uwerr(mul_target)
...
function interp_fpik_constTr_plot()
    ...
    e = err.(vect)
    fill_between(1 ./ xp[:,1], v-e, v+e, color="orange", alpha=0.5)
    errorbar(1 ./ x_s[1:3:9,1], value.(fpik_sh[1:3:9]), err.(fpik_sh[1:3:9]), fmt="x", color="purple", label=L"$a\mu_l^{\rm(v)}=???$")
    ...
    e = err.(vect)
    fill_between(xp[:,2], v-e, v+e, color="orange", alpha=0.5)
    errorbar(x_s[1:3,2], value.(fpik_sh[1:3]), err.(fpik_sh[1:3]), fmt="x", color="purple", label=L"$a\mu_l^{\rm(v)}=???$")
    errorbar(x_s[4:6,2], value.(fpik_sh[4:6]), err.(fpik_sh[4:6]), fmt="x", color="green", label=L"$a\mu_l^{\rm(v)}=???$")
    errorbar(x_s[7:9,2], value.(fpik_sh[7:9]), err.(fpik_sh[7:9]), fmt="x", color="blue", label=L"$a\mu_l^{\rm(v)}=???$")
    mul_target = up[2]; uwerr(mul_target)
    errorbar(value(mul_target), value(fpik_matched), err(fpik_matched), err(mul_target), fmt="x", color="black")
    ax[:set_ylim]([value(fpik_sh[1])*0.97, value(fpik_sh[end])*1.03])
    setp(ax.get_yticklabels(),visible=false)
