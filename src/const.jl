...
const ens_up_fpik = Dict(
    ...
    "N302"     => rand(5),
    "J303"     => [-4923.247920001541, -41.543395343412996, -7.566046337350283, 1346.2369681286518, -92.02474263220637],
    "J500"     => rand(5),
    "J501"     => rand(5)
)
...
const ens_up_fpi = Dict(
    ...
    "N300"     => rand(4),
    "N302"     => rand(4),
    "J303"     => [-36488.462621567, 1.3360835827989037, 10013.79874854552, -687.0395983584117],
    "J500"     => rand(4),
    "J501"     => rand(4)
)
...
const ens_up_fk = Dict(
    ...
    "N300"     => rand(5),
    "N302"     => rand(5),
    "J303"     => [-4919.5133499925305, -14.338127558620663, -3.157168896588286, 1347.7745098834862, -92.30884632374291],
    "J500"     => rand(5),
    "J501"     => rand(5)
)
