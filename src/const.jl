...
const beta_ZA = Dict(
    ...
    3.46 => uwreal([0.76169,0.00093], "b=3.40"),
    3.55 => uwreal([0.76979,0.00043], "b=3.40"),
    3.70 => uwreal([0.78378,0.00047], "b=3.40"),
    3.85 => uwreal([0.79667,0.00047], "b=3.40")
)

const beta_ZP = Dict(
    #beta=>ZP
    3.40 => uwreal([0.35121,0.00056], "b=3.40"),
    3.46 => uwreal([0.34941,0.00044], "b=3.40"),
    3.55 => uwreal([0.34767,0.00055], "b=3.40"),
    3.70 => uwreal([0.34732,0.00063], "b=3.40"),
    3.85 => uwreal([0.35014,0.00073], "b=3.40")
)
