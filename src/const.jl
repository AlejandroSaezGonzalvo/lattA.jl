...
const ens_db = Dict(
    ...
    "H101"     => [32, 96, 3.4, 2, "1.2"],
    "H102r001" => [32, 96, 3.4, 2, "1.2"],
    "H102r002" => [32, 96, 3.4, 2, "1.2"],
    "H105"     => [32, 96, 3.4, 2, "1.2"],
    "H105r005" => [32, 96, 3.4, 1, "1.2"],
    "H400"     => [32, 96, 3.46, 1, "1.2"],
    "N202"     => [48, 128, 3.55, 2, "1.2"],
    "N203"     => [48, 128, 3.55, 1, "1.4"],
    "N200"     => [48, 128, 3.55, 1, "1.2"],
    "D200"     => [64, 128, 3.55, 2, "1.2"],
    "N300"     => [48, 128, 3.70, 1, "1.2"],
    "J303"     => [64, 192, 3.70, 2, "1.2"]
)
