...
function model2_ChPT2_a2(x,p) 
    ...
    kaon = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[7] * x[i,1] for i in 1:div(length(x[:,2]),2)]
    #kaon = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2) - 3/2 * x[i,3] / p[2] ^ 2 * log(2 * (x[i,3] - x[i,2]) / p[2] ^ 2) + 1/2 * x[i,2] / p[2] ^ 2 * log(2 * (x[i,3] - x[i,2]) / p[2] ^ 2)) + p[7] * x[i,1] for i in 1:div(length(x[:,2]),2)]
    return [pion;kaon]
end
...
function model2_ChPT2_a2_combined(x,p)
    ...
    kaon = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[7] * x[i,1] for i in 1:div(length(x[:,2]),4)]
    #t0fpik Wtm:
    pi_tm = [p[1] * x[i,2] + p[2] / (4 * pi) * (1 - 2 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[3] * x[i,3] + p[8] * x[i,1] for i in 1:div(length(x[:,2]),4)]
    ka_tm = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[9] * x[i,1] for i in 1:div(length(x[:,2]),4)]
...
function model2_ChPT2_aas(x,p) 
    ...
    kaon = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[7] * x[i,1] * (-1 / (log(sqrt(x[i,1] * 8 * value(t0_old)) * Lam))) ^ (Gamma_1) for i in 1:div(length(x[:,2]),2)]
    return [pion;kaon]
end
...
function model2_ChPT2_aas_combined(x,p)
    if x[1,1] == 0
        ...
        kaon = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) for i in 1:div(length(x[:,2]),4)]
        #t0fpik Wtm:
        pi_tm = [p[1] * x[i,2] + p[2] / (4 * pi) * (1 - 2 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[3] * x[i,3] for i in 1:div(length(x[:,2]),4)]
        ka_tm = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) for i in 1:div(length(x[:,2]),4)]
        return [pion; kaon; pi_tm; ka_tm]
    else
        #t0fpik Wilson:
        ...
        kaon = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[7] * x[i,1] * (-1 / (log(sqrt(x[i,1] * 8 * value(t0_old)) * Lam))) ^ (Gamma_1) for i in 1:div(length(x[:,2]),4)]
        #t0fpik Wtm:
        pi_tm = [p[1] * x[i,2] + p[2] / (4 * pi) * (1 - 2 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[3] * x[i,3] + p[8] * x[i,1] * (-1 / (log(sqrt(x[i,1] * 8 * value(t0_old)) * Lam))) ^ (Gamma_1) for i in 1:div(length(x[:,2]),4)]
        ka_tm = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[9] * x[i,1] * (-1 / (log(sqrt(x[i,1] * 8 * value(t0_old)) * Lam))) ^ (Gamma_1) for i in 1:div(length(x[:,2]),4)]
        return [pion; kaon; pi_tm; ka_tm]
    end
end

function model2_ChPT2_a2phi2(x,p) 
    pion = [p[1] * x[i,2] + p[2] / (4 * pi) * (1 - 2 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[3] * x[i,3] + (p[4] + p[7] * x[i,2]) * x[i,1] for i in 1:div(length(x[:,2]),2)]
    kaon = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + (p[8] + p[9] * x[i,2]) * x[i,1] for i in 1:div(length(x[:,2]),2)]
    return [pion;kaon]
end

function model2_ChPT2_a2phi2_combined(x,p)
    #t0fpik Wilson:
    pion = [p[1] * x[i,2] + p[2] / (4 * pi) * (1 - 2 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[3] * x[i,3] + (p[4] + p[7] * x[i,2]) * x[i,1] for i in 1:div(length(x[:,2]),4)]
    kaon = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + (p[8] + p[9] * x[i,2]) * x[i,1] for i in 1:div(length(x[:,2]),4)]
    #t0fpik Wtm:
    pi_tm = [p[1] * x[i,2] + p[2] / (4 * pi) * (1 - 2 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[3] * x[i,3] + (p[10] + p[11] * x[i,2]) * x[i,1] for i in 1:div(length(x[:,2]),4)]
    ka_tm = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + (p[12] + p[13] * x[i,2]) * x[i,1] for i in 1:div(length(x[:,2]),4)]
    return [pion; kaon; pi_tm; ka_tm]
end
...
function model2_ChPT2_a2a2phi2_combined(x,p)
    ...
    kaon = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[7] * x[i,1] for i in 1:div(length(x[:,2]),4)]
    #t0fpik Wtm:
    pi_tm = [p[1] * x[i,2] + p[2] / (4 * pi) * (1 - 2 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[3] * x[i,3] + (p[8] + p[9] * x[i,2]) * x[i,1] for i in 1:div(length(x[:,2]),4)]
    ka_tm = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + (p[10] + p[11] * x[i,2]) * x[i,1] for i in 1:div(length(x[:,2]),4)]
    return [pion; kaon; pi_tm; ka_tm]
end
...
function model2_ChPT2_a2phi2a2_combined(x,p)
    ...
    kaon = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + (p[8] + p[9] * x[i,2]) * x[i,1] for i in 1:div(length(x[:,2]),4)]
    #t0fpik Wtm:
    pi_tm = [p[1] * x[i,2] + p[2] / (4 * pi) * (1 - 2 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[3] * x[i,3] + p[10] * x[i,1] for i in 1:div(length(x[:,2]),4)]
    ka_tm = [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[11] * x[i,1] for i in 1:div(length(x[:,2]),4)]
    return [pion; kaon; pi_tm; ka_tm]
end
...
function model_plot_SU2_k(x,p) 
    return [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2)) + p[7] * x[i,1] for i in 1:length(x[:,2])]
    #return [p[5] * x[i,2] + p[6] * x[i,3] + p[2] / (4 * pi) * (1 - 3/4 * x[i,2] / p[2] ^ 2 * log(x[i,2] / p[2] ^ 2) - 3/2 * x[i,3] / p[2] ^ 2 * log(2 * (x[i,3] - x[i,2]) / p[2] ^ 2) + 1/2 * x[i,2] / p[2] ^ 2 * log(2 * (x[i,3] - x[i,2]) / p[2] ^ 2)) + p[7] * x[i,1] for i in 1:length(x[:,2])]
end
