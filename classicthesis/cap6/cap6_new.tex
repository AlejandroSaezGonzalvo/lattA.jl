...
%
The charm quark mass dependence of a given observable can in this way be parameterized through a global fit including terms of $\mathcal{O}(a, \phi_2, \phi_H^{(i)})$, and we perform a global fit to obtain its physical value corresponding to $a=0,\; \phi_2^{\mathrm{ph}},\; \phi_H^{(i),\mathrm{ph}}$.
%
