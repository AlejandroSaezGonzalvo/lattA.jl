...
ChPT can be used to study finite volume effects on certain class of observables. In particular, to NLO the pion and kaon masses and decay constants receive the following corrections~\citep{Colangelo:2003hf,Colangelo:2005gd}
\begin{equation}
...
PCAC quark masses being short distance observables and are less sensitive to finite volume effects.
