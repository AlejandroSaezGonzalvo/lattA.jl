...
\begin{align}
\label{ch_ss:eq:t0*}
\sqrt{t_0^*}&=0.1439()_{\textrm{stat}}()_{\textrm{syst}}\;\textrm{fm, Wilson}, \\
\sqrt{t_0^*}&=0.1440()_{\textrm{stat}}()_{\textrm{syst}}\;\textrm{fm, Mixed action}, \\
\sqrt{t_0^*}&=0.1438()_{\textrm{stat}}()_{\textrm{syst}}\;\textrm{fm, Combined}.
\end{align}
