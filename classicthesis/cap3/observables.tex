...
\end{equation}
We assume that the boundary states $\left|\phi_{i,f}\right>$ share the same quantum numbers of the vacuum $\left|\Omega\right>$. This is true when using open boundary conditions (OBC) in time, which will be the case for most of the ensembles under study (see Table~\ref{apex_ensembles:tab:ens}).
