...
In lattice simulations typically one measures a primary observable $p_i$ over several ensembles (defined by the simulation parameters like the inverse coupling $\beta$ and $\kappa$ parameter) 
\begin{equation}
